...
// A payload is read into a buffer of its own as it arrives, which starts no
// smaller than this and doubles as it fills. A peer that declares a large frame
// is therefore only ever committed to as much as it has actually sent, while
// one whose frame arrives in ordinary reads has room made for it once.
exports.MIN_PAYLOAD_CAPACITY = 1024
